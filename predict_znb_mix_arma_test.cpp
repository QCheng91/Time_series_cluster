...
// [[Rcpp::export]]
mat predict_cluster_prob(umat data_x1, mat theta_fit, mat theta0_c_fit, mat mu_c_fit, mat phi_c_fit, vec day_indx){
  int num_cells = data_x1.n_rows;
  int num_clust = theta_fit.n_rows;
  int num_prot  = data_x1.n_cols;
  double theta_c_t, log_lik_i;
  double mu_c_p, theta_0, phi_c_p, mu_i;
...
// [[Rcpp::export]]
vec predict_cluster(umat data_x1, mat theta_fit, mat theta0_c_fit, mat mu_c_fit, mat phi_c_fit, vec day_indx){
  int num_cells = data_x1.n_rows;
  int num_clust = theta_fit.n_rows;
  ...
  mat prob_matx = predict_cluster_prob(data_x1, theta_fit, theta0_c_fit, mu_c_fit, phi_c_fit, day_indx);
